...
class SengketaChartWidget extends ChartWidget
{
    protected static ?int $sort = 6;
    protected static ?string $heading = 'Statistik Data Sengketa';
    ...
    protected function getData(): array
    {
        ...
        if ($filter === 'per_tahun') {
            ...
            // Data per tahun
            $dataPerTahun = DB::table('sengketas')
                ->select('tahun', DB::raw('COUNT(*) as total'))
                ->whereNotNull('tahun')
                ->groupBy('tahun')
                ->orderBy('tahun')
