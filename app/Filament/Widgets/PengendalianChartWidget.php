...
class PengendalianChartWidget extends ChartWidget
{
    protected static ?int $sort = 5;
    protected static ?string $heading = 'Statistik Data Pengendalian';
    ...
    protected function getData(): array
    {
        ...
        if ($filter === 'per_tahun') {
            ...
            $dailyData = DB::table('pengendalians')
            ...
            // Data per tahun
            $dataPerTahun = DB::table('pengendalians')
                ->select('tahun', DB::raw('COUNT(*) as total'))
                ->whereNotNull('tahun')
                ->groupBy('tahun')
                ->orderBy('tahun')
